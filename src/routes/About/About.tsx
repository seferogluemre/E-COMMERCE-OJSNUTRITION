            ...
            <div className="col-12">
              ...
              <div className="d-flex flex-column gap-3">
                ...
                <p className="mb-3">
                  ...
                  fonksiyonel gıdaları üreten bir firma olarak; müşterilerimize
                  en kaliteli, lezzetli, tüketilmesi kolay ürünleri sunuyoruz.{" "}
                  <br />
                  <br /> Müşteri memnuniyeti ve sağlığı her zaman önceliğimiz
                  ...
                  mineral takviyeleri ile spor performansınızı desteklemek için
                  ideal besin değerlerini sunuyoruz. <br /> <br />
              ...
              <div className="mt-4">
                ...
                <div>
                  <span className="d-inline-block bg-primary text-white p-2 m-1 rounded-pill fw-bolder">
                    ÜRÜN İNCELEMELERİ
                  </span>
                </div>
              </div>
